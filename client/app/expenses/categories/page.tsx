...
export default function ExpenseCategoriesPage() {
    ...
    const fetchCategories = async () => {
        try {
            const response = await fetch('http://localhost:5000/expense-categories');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const url = editMode
                ? `http://localhost:5000/expense-categories/${currentCategory.category_id}`
                : 'http://localhost:5000/expense-categories';
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/expense-categories/${id}`, {
                method: 'DELETE'
            });
